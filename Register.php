...
<body class="bg-light min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="bg-primary py-6 px-4">
            <h2 class="text-2xl font-bold text-center text-light">Register</h2>
        </div>
        
        <form action="process/register_process.php" method="post" class="py-8 px-6 space-y-6">
            <div class="space-y-2">
            ...
            <div class="space-y-2">
                <label for="email" class="block text-sm font-medium text-gray-700">Masukan Email anda</label>
                <div class="relative">
                    <input type="email" name="email" id="email" autocomplete="off" placeholder="masukan email anda" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent bg-light"
                        required />
                </div>
            </div>
            ...
            <div class="text-center mt-4">
                <p class="text-sm text-gray-600">
                    Sudah punya akun? 
                    <a href="Login.php" class="text-secondary hover:text-primary font-medium">
                        Login disini
                    </a>
                </p>
            </div>
